...
function LinkRow({
  ...
  return (
    <tr
      onClick={onOpen}
      tabIndex={0}
      // A tr is announced as a table row, so nothing signals that Enter
      // does anything; haspopup at least announces that activation opens
      // something. Real row semantics need role=grid, deferred until the
      // table earns a full grid treatment.
      ...
      className={cn(
        "group cursor-pointer outline-none transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-ring/60 focus-visible:-outline-offset-2",
        rowSelected
