...
export function CTA() {
  return (
    <Band className="px-6 py-24 text-center sm:py-32">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 inset-y-0 overflow-hidden [mask-image:radial-gradient(ellipse_70%_80%_at_50%_100%,black,transparent)] sm:-inset-x-40"
      >
