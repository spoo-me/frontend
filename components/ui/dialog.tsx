  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Centred with -translate-y-1/2, so without a height bound tall
          // content grows off BOTH edges of the viewport and the footer
          // actions become unreachable. dvh keeps mobile browser chrome out
          // of the calculation.
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading font-semibold text-lg leading-6 tracking-tight",
        className
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-muted-foreground text-sm leading-5 *:[a]:underline *:[a]:underline-offset-3 *:[a]:hover:text-foreground",
        className
      )}
      {...props}
    />
