  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        // so a single unbroken URL widened the textarea past its dialog and
        // pushed the submit button off-screen. max-w-full clamps the width and
        // anywhere-wrapping breaks long tokens, so it only ever grows down.
