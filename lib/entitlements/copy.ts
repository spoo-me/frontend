 ...
 * prose, so the locked states, the limit counters and the upgrade page all
...
export type LimitCopy = {
  ...
  noun: string
  /** Shown inline when the add affordance is disabled at the limit. */
  atLimit: string
}
...
export const LIMIT_COPY: Record<LimitName, LimitCopy> = {
  custom_domains_max: {
    label: "Domains",
    noun: "domain",
    atLimit: "Your plan's domain limit is reached.",
  },
  webhook_endpoints_max: {
    label: "Endpoints",
    noun: "endpoint",
    atLimit: "Your plan's endpoint limit is reached.",
  },
  api_keys_max: {
    label: "API keys",
    noun: "key",
    atLimit: "Your plan's key limit is reached.",
  },
  analytics_window_days: {
    label: "Analytics window",
    noun: "day",
    atLimit: "Older clicks are outside your plan's window.",
  },
  api_rate_multiplier: {
    label: "API rate",
    noun: "request",
    atLimit: "Your plan's rate limit is reached.",
  },
  bulk_batch_max: {
    label: "Bulk batch",
    noun: "link",
    atLimit: "Your plan's batch size is reached.",
  },
}
