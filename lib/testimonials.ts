...
export const testimonials: Testimonial[] = [
  {
    ...
    fullQuote: [
      ...
      ". Need a quirky emoji slug for social media? Done. Want to lock it down with a password or cap the number of clicks? Easy. I dive into the dashboard, grab stats, and export everything faster than my caffeine fix kicks in. ",
      { em: "Free, open source, and zero sign-up nonsense" },
      ". It's everything I need when I want to just get stuff done. It's ",
